...
_BUILTIN_DEFAULTS: dict[str, Any] = {
    ...
    "features": {
        ...
        "otel_enabled": True,
        "event_outbox": True,
        "domain_event_outbox": False,
        "domain_webhook_delivery": False,
        "domain_webhook_dedupe": True,
        "event_stream": True,
...
_FEATURE_ENV_MAP = {
    ...
    "domain_event_outbox": "ML_AIR_DOMAIN_EVENT_OUTBOX",
    "domain_webhook_delivery": "ML_AIR_DOMAIN_WEBHOOK_DELIVERY",
    "domain_webhook_dedupe": "ML_AIR_DOMAIN_WEBHOOK_DEDUPE",
    ...
    "projections_enabled": "ML_AIR_PROJECTIONS_ENABLED",
    "timeline_projection_reads": "ML_AIR_TIMELINE_PROJECTION_READS",
    "dashboard_projection_reads": "ML_AIR_DASHBOARD_PROJECTION_READS",
    "notification_delivery": "ML_AIR_NOTIFICATION_DELIVERY",
    "integration_delivery": "ML_AIR_INTEGRATION_DELIVERY",
    "event_retention_enabled": "ML_AIR_EVENT_RETENTION_ENABLED",
    "siem_export_enabled": "ML_AIR_SIEM_EXPORT_ENABLED",
    "event_schema_registry_enabled": "ML_AIR_EVENT_SCHEMA_REGISTRY_ENABLED",
    ...
    "multi_cluster": "ML_AIR_MULTI_CLUSTER",
    "multi_region": "ML_AIR_MULTI_REGION",
    "federation": "ML_AIR_FEDERATION",
    "edge_deployment": "ML_AIR_EDGE_DEPLOYMENT",
    "global_scheduler": "ML_AIR_GLOBAL_SCHEDULER",
    "cross_region_replication": "ML_AIR_CROSS_REGION_REPLICATION",
    "disaster_recovery": "ML_AIR_DISASTER_RECOVERY",
