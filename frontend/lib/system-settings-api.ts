...
export const FEATURE_FLAG_META: Array<{ key: string; label: string; group: string }> = [
  ...
  { key: "cost_aware_scheduler", label: "Cost-aware scheduler", group: "AI control plane" },
  { key: "ai_gateway", label: "AI gateway", group: "AI control plane" },
  { key: "chargeback", label: "Usage chargeback", group: "AI control plane" },
  { key: "prompt_management", label: "Prompt management", group: "AI control plane" },
  { key: "policy_engine", label: "Policy engine", group: "AI control plane" },
  { key: "copilot", label: "AI copilot", group: "AI control plane" },
