      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            className="flex max-w-[10rem] items-center gap-2 rounded-md border border-border/60 bg-muted/30 px-2.5 py-1.5 transition-default hover:bg-muted/50 sm:max-w-none"
          >
