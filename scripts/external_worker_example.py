...
Requires:
  ...
  - Service Account secret on the worker (ML_AIR_SERVICE_ACCOUNT_TOKEN / ML_AIR_SA_WORKER_SECRET)
    (or MLAIR_WORKER_TOKEN / ML_AIR_WORKER_TOKEN)
  - psutil in worker env

Env:
  MLAIR_API_BASE_URL / ML_AIR_API_BASE_URL   default http://localhost:8080
  ML_AIR_SERVICE_ACCOUNT_TOKEN / ML_AIR_SA_WORKER_SECRET / MLAIR_WORKER_TOKEN
