"""Decode bearer token for WebSocket (same env contract as MLAir API auth_service)."""
...
def _principal_from_token_data(token: str, token_data: dict) -> Principal | None:
...
def decode_principal(raw_token: str) -> Principal | None:
...
def authorize_ws(principal: Principal, tenant_id: str, project_id: str, min_role: str = "viewer") -> bool:
