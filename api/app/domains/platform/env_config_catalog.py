...
def _feature_entries() -> list[CatalogEntry]:
    labels = {
        ...
        "cost_aware_scheduler": "Cost-aware run scheduling (priority queue)",
        "ai_gateway": "Unified AI gateway (LLM proxy)",
        "chargeback": "Usage attribution and chargeback",
        "prompt_management": "Prompt versioning and deployment",
        "policy_engine": "Unified policy engine",
        "copilot": "Hub AI copilot",
