"""Integration platform subscriber on Domain Events."""
...
from app.domains.projections.integration_service import schedule_integrate_from_envelope
...
class IntegrationEventHandler(DomainEventHandler):
    def handle(self, envelope: EventEnvelope, *, session) -> None:  # noqa: ANN001
        schedule_integrate_from_envelope(envelope)


def start_integration_subscriptions() -> None:
    bus = get_event_bus()
