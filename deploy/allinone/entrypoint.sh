...
export OTEL_EXPORTER_OTLP_ENDPOINT="${OTEL_EXPORTER_OTLP_ENDPOINT:-tempo:4317}"
export OTEL_EXPORTER_OTLP_INSECURE="${OTEL_EXPORTER_OTLP_INSECURE:-true}"
export ML_AIR_TEMPO_QUERY_URL="${ML_AIR_TEMPO_QUERY_URL:-http://tempo:3200}"
export ML_AIR_TRACE_OTEL_SPANS="${ML_AIR_TRACE_OTEL_SPANS:-1}"
